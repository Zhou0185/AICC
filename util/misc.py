...
#https://stackoverflow.com/questions/76255578/importerror-cannot-import-name-newemptytensorop-from-torchvision-ops-misc
import torchvision
# if float(torchvision.__version__[:3]) < 0.7:
#     from torchvision.ops import _new_empty_tensor
#     from torchvision.ops.misc import _output_size
# if float(torchvision.__version__) < Version('0.7.0'):
#     from torchvision.ops import _new_empty_tensor
#     from torchvision.ops.misc import _output_size
