...
class NEFCell(Dataset):
    def __init__(self, data_root, transform=None, train=False, patch=False, flip=False):
        self.root_path = data_root
        self.train_lists = "/mnt/disk3/zrj/MYP2PNET_ROOT/crowd_datasets/NEFCell/DATA_ROOT/train.list"
        self.eval_list = "/mnt/disk3/zrj/MYP2PNET_ROOT/crowd_datasets/CNEFCell/DATA_ROOT/test.list"#43090
